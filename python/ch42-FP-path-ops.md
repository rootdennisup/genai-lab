...
demo 示例：[manual_file](../codes/python_base/fp/manual_file.py)
...
with 表达式 [as 变量]:
    # 在此缩进块内执行操作
```
- demo 示例：[with_demo](../codes/python_base/fp/with_demo.py)
...
- [urllib_request_demo](../codes/python_base/fp/urllib_request_demo.py)
...
- [urllib_error_demo](../codes/python_base/fp/urllib_error_demo.py)
...
- [urllib_parse_demo](../codes/python_base/fp/urllib_parse_demo.py)
